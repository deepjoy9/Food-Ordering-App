...
const Body = () => {
  ...
  return loading ? (
    ...
    <div className="body">
      <div className="filter bg-[url('./assets/background-img.jpg')] text-slate-100 text-center p-5">
        <div className="m-8 mt-0 whitespace-nowrap">
          <div className="heading text-3xl font-Oswald">
      ...
      <div className="mx-10 my-10 p-5">
        {noReserr && (
          <div className="flex items-center justify-center text-center">
            {" "}
            <p className="text-lg text-red-700 font-semibold ">{noReserr}</p>
          </div>
        )}
        <div
